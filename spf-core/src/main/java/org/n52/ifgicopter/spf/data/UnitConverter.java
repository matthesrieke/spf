...
/**
 * An example implementation of {@link AbstractDataProcessor}.
 * This class converts units of measurements if needed.
 * 
...
public class UnitConverter extends AbstractDataProcessor {
	...
	/**
	 * Default constructor calling the superconstructor.
	 * 
	 * @param plugin the plugin description.
	 */
	public UnitConverter(Plugin plugin) {
		super(plugin);
	}
